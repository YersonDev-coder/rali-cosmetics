    ...
    <footer className="bg-primary-dark text-white mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              ...
              <a
                href="https://www.facebook.com/ralicosmeticspe/?locale=bs_BA"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook de RALI Cosmetics"
                className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full text-sm font-semibold transition-colors"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://www.instagram.com/ralicosmeticspe/reels/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram de RALI Cosmetics"
                className="inline-flex items-center gap-2 bg-pink-600 hover:bg-pink-700 text-white px-4 py-2 rounded-full text-sm font-semibold transition-colors"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://www.tiktok.com/@ralicosmeticspe"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok de RALI Cosmetics"
                className="inline-flex items-center gap-2 bg-black hover:bg-gray-800 text-white px-4 py-2 rounded-full text-sm font-semibold transition-colors"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-100">
              {['Bases', 'Labiales', 'Rimel', 'Delineadores', 'Brochas', 'Cuidado de Piel'].map(cat => (
                <li key={cat}>
        ...
        <div className="border-t border-primary-400 mt-8 pt-6 text-center text-sm text-primary-200">
          © {new Date().getFullYear()} RALI Cosmetics. Todos los derechos reservados.
        </div>
      </div>
    </footer>
  );
